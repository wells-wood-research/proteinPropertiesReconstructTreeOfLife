# This script is the data prep script which prepares the AF2 structures data
# for single AF2DB cluster (single proteins)
...
raw_data_path = "data/raw_data/superoxide_dismutase_trunc/"

# Defining the path for the processed data
processed_data_path = "data/processed_data/"

# Defining the file path for the AF2 raw destress data
raw_destress_data_af2_path = raw_data_path + "design_data.csv"
...
processed_data_af2_path = "data/processed_data_single_af2db_cluster/af2/"
...
remove_redundant_af2_models = False
